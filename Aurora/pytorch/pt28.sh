...
build_pytorch() {
    ...
    log_message INFO "Checking out release/2.8 branch..."
...
build_ipex() {
    ...
    log_message INFO "Checking out last commit before 2.9 release..."
    log_message INFO "see: <https://github.com/intel/intel-extension-for-pytorch/commit/973860d7036080ad1d6f523a85c4dbd9c72e8e81>"
    git checkout 973860d
...
build_torch_ccl() {
    ...
    log_message INFO "Checking out specific commit c27ded5..."
